...
if (!ref) {
    const latestRelease = await fetch("https://api.github.com/repos/Nasafrasa/NasafrasasReMapperUtilities/releases/latest", { // This would have to be changed after PR
        headers: {
...
console.log("\x1b[35m%s\x1b[0m", "[N]", `Successfully setup nasafrasa's functions at ${destFolder}`)
